      ...
      <Container maxWidth="lg">
        <Grid container spacing={10}>
          ...
          <Grid item xs={4}>
            ...
            <Typography variant="body2">Highest Bid: # SOL</Typography>
            ...
            <Typography gutterBottom color="fontSecondary" variant="body2">
              XiD Technologies is introducing the ability for an individual to
              purchase a fractional ownership of XiD’s 6 existing patents and
              technologies in the form of a Fractional Non-Fungible Token,
              creating a brand...
            </Typography>
...
const Attribute = () => {
  return (
    <Box p={2} bgcolor="#090D4C" borderRadius={"20px"}>
