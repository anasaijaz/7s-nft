...
import xidimg from "../../assets/png/xid.jpg";
  ...
  return (
    <>
      <Container maxWidth="lg" component={Box}>
        ...
        <NFTList round={BigNumber.from(currentRound ?? "0").toNumber()} />
      ...
      {[
        {
          id: 1,
          title:
            "F-NFT owner has fractional ownership of XiD’s Intellectual Property and will be able to monetize the 2 US Granted Patents and Singapore Patents",
        },
        {
          id: 2,
          title:
            " The F-NFT owners will have fractional ownership in any future international patents derived from all granted patents",
        },
        {
          id: 3,
          title:
            "F-NFT owners will receive passive income from product royalties for up to 5 years",
        },
        {
          id: 4,
          title:
            "F-NFT owners will receive passive income from every licence sold for up to 5 years",
        },
        {
          id: 5,
          title:
            "F-NFT owners will receive portion of net profits from selling the XiD product and service",
        },
      ].map((item) => (
        <Grid
          container
        ...
        >
          ...
          >
            <Typography
              variant="h2"
              fontWeight={800}
              color={item.id % 2 ? "secondary" : "primary"}
              textAlign="center"
            >
              {item.id}
            </Typography>
...
export const NFT = ({ round }): { round: number } => {
  ...
  const onBuyNFT = async () => {
    ...
    try {
      ...
      const approveTx = await usdcToken.approve(xidNFT?.address, price);
      await approveTx.wait();

      const buyTx = await xidNFT.buy();
      await buyTx.wait();
    } catch (err) {
      console.log(err);
    }
  ...
  return (
    ...
    >
      ...
      <Box p={2}>
        <Typography variant="body1">NFT</Typography>
